...
class PepiDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    std::tuple<G4LogicalVolume*,G4VPhysicalVolume*> CreateMask(G4String, G4double, G4double, G4ThreeVector, G4double, G4Material*, G4LogicalVolume*, G4VPhysicalVolume*);
    void Move(G4String, G4LogicalVolume*, G4VPhysicalVolume*, G4ThreeVector,G4LogicalVolume*);
    std::tuple<G4LogicalVolume*,G4VPhysicalVolume*> CreateSubstrate(G4String, G4ThreeVector, G4double, G4Material*, G4LogicalVolume*, G4VPhysicalVolume*);
    // Public Get Methods
  ...
  private:
    ...
    // Add the materials associated with the object you created:
    G4Material* fMuscleMaterial;
    G4Material* fMySphereMaterial;
    ...
    // Add the volumes associated with the object you created:
    G4Box* fMuscleSolid;
    G4Ellipsoid* fMySphereSolid;
    ...
    // Add the logical volumes associated with the object you created:
    G4LogicalVolume* fMuscleLogical;
    G4LogicalVolume* fMySphereLogical;
    G4LogicalVolume* fWaxInsertLogical;


    //....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

    // Physical volume declaration:
    ...
    // Add the physical volumes associated with the object you created:
    G4VPhysicalVolume* fMusclePhysical;
    G4VPhysicalVolume* fMySpherePhysical;
